<div class="ayudas-widget-popup">
	<#if (imagen.getData())??>
		<div class="div_left">
			<img src="${imagen.getData()}" >
		</div>
	</#if>
	<div class="av-ac-nd__right">
		<div class="av-ac-nd__text">
		<#if (titulo.getData())??>
			${titulo.getData()}
		</#if>
		</div>
		<#if (descripcionCorta.getData())??>
			${descripcionCorta.getData()}
		</#if>
		<div class="av-ac-nd__date">
			...
			<#if validator.isNotNull(fechaInicioSolicitud_Data)>
				...
				<#assign fechaSolicitud = dateUtil.getDate(fechaInicioSolicitud_DateObj, "dd/MM/yyyy", locale)>
