...
<aui:form action="<%= updateFormCalendarBookingURL %>" method="post" name="fm"
          onSubmit='<%= "event.preventDefault(); validateRelatedAssets() && " + liferayPortletResponse.getNamespace() + "updateCalendarBooking();" %>'>
        ...
        <clay:sheet>
            ...
            <clay:panel-group>
                ...
                <c:if test="<%= calendarBookingId > 0 %>">
                    <!--TODO: añadir los literales como properties -->
                    <clay:panel
                            displayTitle='Protagonistas'
                    >
                        <div class="panel-body">
