...
page import="avanis.eventos.minicalendar.constants.AvanisEventosMiniCalendarKeys" %><%@
page import="avanis.eventos.minicalendar.display.context.CalendarDisplayContext" %><%@
page import="avanis.eventos.minicalendar.search.CalendarResourceDisplayTerms" %><%@
page import="avanis.eventos.minicalendar.security.permission.resource.CalendarBookingPermission" %><%@
page import="avanis.eventos.minicalendar.security.permission.resource.CalendarPermission" %><%@
page import="avanis.eventos.minicalendar.security.permission.resource.CalendarPortletPermission" %><%@
page import="avanis.eventos.minicalendar.security.permission.resource.CalendarResourcePermission" %><%@
page import="avanis.eventos.minicalendar.util.CalendarResourceUtil" %><%@
page import="avanis.eventos.minicalendar.util.CalendarUtil" %><%@
page import="avanis.eventos.minicalendar.util.ColorUtil" %><%@
...
// Valido y fuerzo una vista válida
	if ("agenda".equals(sessionClicksDefaultView)) {
		sessionClicksDefaultView = "month"; // Cambiar a "month", "day" o "week".
	}
...
CalendarBooking calendarBooking = (CalendarBooking)request.getAttribute(AvanisEventosMiniCalendarKeys.CALENDAR_BOOKING);
...
CalendarDisplayContext calendarDisplayContext = (CalendarDisplayContext)renderRequest.getAttribute(AvanisEventosMiniCalendarKeys.CALENDAR_DISPLAY_CONTEXT);
