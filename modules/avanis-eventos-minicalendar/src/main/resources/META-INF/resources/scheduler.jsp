...
<%--WRAPPER--%>
<hr class="eventos-separador">

<div class ="container-eventos"></div>
<div class="error-cero-eventos" style="display:none">
	<img class="candado" src="<%=request.getContextPath()%>/images/calendar.png" alt="calendar" />
	<p>No hay eventos </p>
	<p>para el día seleccionado</p>
</div>
...
<aui:script use="aui-toggler,json,liferay-calendar-list,liferay-scheduler">
	...
	<c:if test="<%= !hideAgendaView %>">
		...
		content: function(scheduler) {
		// Customize the rendering of the event
		return '<div class="PITO">' + scheduler.get('content') + '</div>';
		},
		...
		showMore: '<liferay-ui:message key="show-more" />'
		}
		});
	</c:if>
