...
@Component(
	property = {
		"class.name=avanis.lonjas.model.impl.AreaImpl",
		"table.name=AVANIS_LONJAS_Area"
	},
...
public class AreaModelArgumentsResolver implements ArgumentsResolver {
	...
	static {
		...
		orderByColumnsBitmask |= AreaModelImpl.getColumnBitmask("grupoId");
		orderByColumnsBitmask |= AreaModelImpl.getColumnBitmask("subGrupoId");
		orderByColumnsBitmask |= AreaModelImpl.getColumnBitmask("areaId");
