 ...
 * <code>avanis.lonjas.service.impl.AreaLocalServiceImpl</code> and
...
public class AreaLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>avanis.lonjas.service.impl.AreaLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 * @return the new area
	 */
	public static Area createArea(long entityId) {
		return getService().createArea(entityId);
	}
	 ...
	 */
	public static Area deleteArea(long entityId) throws PortalException {
		return getService().deleteArea(entityId);
	}
	...
	public static Area fetchArea(long entityId) {
		return getService().fetchArea(entityId);
	}
	 ...
	 * @throws PortalException if a area with the primary key could not be found
	 */
	public static Area getArea(long entityId) throws PortalException {
		return getService().getArea(entityId);
	}
	...
	public static void setService(AreaLocalService service) {
		_service = service;
	}

	private static volatile AreaLocalService _service;
