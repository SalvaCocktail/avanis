...
/**
 * Provides the local service utility for ProductoExplot. This utility wraps
 * <code>avanis.lonjas.service.impl.ProductoExplotLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ProductoExplotLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>avanis.lonjas.service.impl.ProductoExplotLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ProductoExplot addProductoExplot(
		ProductoExplot productoExplot) {

		return getService().addProductoExplot(productoExplot);
	}
	 ...
	 */
	public static ProductoExplot createProductoExplot(long entityId) {
		return getService().createProductoExplot(entityId);
	}
	 ...
	 */
	public static ProductoExplot deleteProductoExplot(long entityId)
		throws PortalException {

		return getService().deleteProductoExplot(entityId);
	}
	 ...
	 * @return the producto explot that was removed
	 */
	public static ProductoExplot deleteProductoExplot(
		ProductoExplot productoExplot) {

		return getService().deleteProductoExplot(productoExplot);
	}
	...
	public static ProductoExplot fetchProductoExplot(long entityId) {
		return getService().fetchProductoExplot(entityId);
	}
	 ...
	 * @throws PortalException if a producto explot with the primary key could not be found
	 */
	public static ProductoExplot getProductoExplot(long entityId)
		throws PortalException {

		return getService().getProductoExplot(entityId);
	}

	public static List<ProductoExplot> getProductoExplotByExplotacionId(
		long explotacionId) {

		return getService().getProductoExplotByExplotacionId(explotacionId);
	}
	 ...
	 */
	public static List<ProductoExplot> getProductoExplots(int start, int end) {
		return getService().getProductoExplots(start, end);
	}
	 ...
	 */
	public static int getProductoExplotsCount() {
		return getService().getProductoExplotsCount();
	}
	 ...
	 */
	public static ProductoExplot updateProductoExplot(
		ProductoExplot productoExplot) {

		return getService().updateProductoExplot(productoExplot);
	}

	public static ProductoExplotLocalService getService() {
		return _service;
	}

	public static void setService(ProductoExplotLocalService service) {
		_service = service;
	}

	private static volatile ProductoExplotLocalService _service;
