...
/**
 * Provides the local service interface for Grupo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see GrupoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface GrupoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>avanis.lonjas.service.impl.GrupoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the grupo local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link GrupoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Grupo findByGroupId(long groupId);
