...
/**
 * Provides the local service interface for SubGrupo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SubGrupoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SubGrupoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>avanis.lonjas.service.impl.SubGrupoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the sub grupo local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SubGrupoLocalServiceUtil} if injection and service tracking are not available.
	 */
