...
/**
 * Provides the local service interface for FechaLonja. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FechaLonjaLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FechaLonjaLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>avanis.lonjas.service.impl.FechaLonjaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the fecha lonja local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FechaLonjaLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public FechaLonja addFechaLonja(FechaLonja fechaLonja);
	...
	public FechaLonja createFechaLonja(long entityId);
	...
	public FechaLonja deleteFechaLonja(FechaLonja fechaLonja);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public FechaLonja deleteFechaLonja(long entityId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FechaLonja fetchFechaLonja(long entityId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FechaLonja getFechaLonja(long entityId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FechaLonja> getFechaLonjas(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public FechaLonja updateFechaLonja(FechaLonja fechaLonja);
