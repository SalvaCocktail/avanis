...
/**
 * Provides the local service interface for ProductoExplot. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ProductoExplotLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ProductoExplotLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>avanis.lonjas.service.impl.ProductoExplotLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the producto explot local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ProductoExplotLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public ProductoExplot addProductoExplot(ProductoExplot productoExplot);
	...
	public ProductoExplot createProductoExplot(long entityId);
	...
	public ProductoExplot deleteProductoExplot(long entityId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public ProductoExplot deleteProductoExplot(ProductoExplot productoExplot);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ProductoExplot fetchProductoExplot(long entityId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ProductoExplot getProductoExplot(long entityId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ProductoExplot> getProductoExplotByExplotacionId(
		long explotacionId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ProductoExplot> getProductoExplots(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ProductoExplot updateProductoExplot(ProductoExplot productoExplot);
