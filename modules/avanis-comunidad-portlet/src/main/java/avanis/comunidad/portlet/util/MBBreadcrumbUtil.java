...
public class MBBreadcrumbUtil {
	...
	public static void addPortletBreadcrumbEntries(
		...
		if (mvcRenderCommandName.equals("/avanis_message_boards/select_category")) {
			portletURL.setParameter(
				"mvcRenderCommandName", "/avanis_message_boards/select_category");
	...
	public static void addPortletBreadcrumbEntries(
		...
		PortalUtil.addPortletBreadcrumbEntry(
			...
			PortletURLBuilder.createRenderURL(
				...
				"/avanis_message_boards/view_message"
			).setParameter(
