...
public class MBNavigationDisplayContext {
	...
	public MBNavigationDisplayContext(
		...
		_mvcRenderCommandName = ParamUtil.getString(
			httpServletRequest, "mvcRenderCommandName", "/avanis_message_boards/view");
	...
	private PortletURL _getViewMyPostsPortletURL() {
		return PortletURLBuilder.createRenderURL(
			...
			"/avanis_message_boards/view_my_posts"
		).buildPortletURL();
	}
	...
	private PortletURL _getViewMySubscriptionsPortletURL() {
		return PortletURLBuilder.createRenderURL(
			...
			"/avanis_message_boards/view_my_subscriptions"
		).buildPortletURL();
	}
	...
	private PortletURL _getViewRecentPostsPortletURL() {
		return PortletURLBuilder.createRenderURL(
			...
			"/avanis_message_boards/view_recent_posts"
		).buildPortletURL();
	}
	...
	private boolean _isMBPortlet() {
		...
		if (Objects.equals(
				...
				AvanisComunidadPortletKeys.AVANISCOMUNIDAD)) {
	...
	private boolean _isViewCategoriesNavigationItemActive() {
		if (_mvcRenderCommandName.equals("/avanis_message_boards/edit_category") ||
			_mvcRenderCommandName.equals("/avanis_message_boards/edit_message") ||
			_mvcRenderCommandName.equals("/avanis_message_boards/view") ||
			_mvcRenderCommandName.equals("/avanis_message_boards/view_category") ||
			_mvcRenderCommandName.equals("/avanis_message_boards/view_message")) {
	...
	private boolean _isViewMyPostsNavigationItemActive() {
		if (_mvcRenderCommandName.equals("/avanis_message_boards/view_my_posts")) {
			return true;
		}
	...
	private boolean _isViewRecentPostsNavigationItemActive() {
		if (_mvcRenderCommandName.equals("/avanis_message_boards/view_recent_posts")) {
			return true;
		}
	...
	private boolean _isViewStatisticsNavigationItemActive() {
		if (_mvcRenderCommandName.equals("/avanis_message_boards/view_statistics")) {
			return true;
		}
