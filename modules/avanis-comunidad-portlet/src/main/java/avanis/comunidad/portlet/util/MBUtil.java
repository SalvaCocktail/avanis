...
public class MBUtil {
	...
	public static String getBBCodeNormalize(String msgBody){
	...
	public static String getBBCodeHTML(String msgBody, String pathThemeImages) {
		msgBody = getBBCodeNormalize(msgBody);
		return StringUtil.replace(BBCodeTranslatorUtil.getHTML(msgBody), "@theme_images_path@/emoticons", pathThemeImages + "/emoticons");
	}
	...
	public static long getCategoryId(
		...
		return ParamUtil.getLong(
			httpServletRequest, "categoryId", categoryId);
	}
	...
	public static String getMBMessageURL(
		...
		return StringBundler.concat(
			...
			"publicaciones/", messageId, StringPool.POUND,
