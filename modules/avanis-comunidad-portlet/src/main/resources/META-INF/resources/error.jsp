<%@ page import="avanis.comunidad.portlet.exceptions.ForbiddenMessageException" %><%--
/**
...
<liferay-ui:error exception="<%= ForbiddenMessageException.class %>" message="private-message" />
