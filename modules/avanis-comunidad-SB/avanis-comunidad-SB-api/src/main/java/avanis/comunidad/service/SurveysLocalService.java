...
/**
 * Provides the local service interface for Surveys. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SurveysLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SurveysLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>avanis.comunidad.service.impl.SurveysLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the surveys local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SurveysLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Surveys addSurveys(Surveys surveys);
	...
	public Surveys createSurveys(long surveyId);

	public Surveys createUpdate(
	...
	public Surveys deleteSurveys(long surveyId) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Surveys deleteSurveys(Surveys surveys);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Surveys fetchSurveys(long surveyId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Surveys fetchSurveysByUuidAndGroupId(String uuid, long groupId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Surveys getSurveys(long surveyId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Surveys getSurveysByUuidAndGroupId(String uuid, long groupId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Surveys> getSurveyses(int start, int end);
