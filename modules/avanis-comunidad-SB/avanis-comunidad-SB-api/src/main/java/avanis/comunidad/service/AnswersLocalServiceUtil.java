 ...
 * <code>avanis.comunidad.service.impl.AnswersLocalServiceImpl</code> and
...
public class AnswersLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>avanis.comunidad.service.impl.AnswersLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Answers createAnswers(long answerId) {
		return getService().createAnswers(answerId);
	}
	...
	public static List<Answers> createUpdate(
		String[] answers, List<Long> answersIds, long surveyId) {

		return getService().createUpdate(answers, answersIds, surveyId);
	}
	 ...
	 */
	public static Answers deleteAnswers(Answers answers) {
	 ...
	 */
	public static Answers deleteAnswers(long answerId) throws PortalException {
		return getService().deleteAnswers(answerId);
	}
	...
	public static Answers fetchAnswers(long answerId) {
		return getService().fetchAnswers(answerId);
	}
	 ...
	 * @throws PortalException if a answers with the primary key could not be found
	 */
	public static Answers getAnswers(long answerId) throws PortalException {
		return getService().getAnswers(answerId);
	}

	public static List<Answers> getAnswersBySurveyId(long surveyId) {
		return getService().getAnswersBySurveyId(surveyId);
	}
	 ...
	 */
	public static List<Answers> getAnswerses(int start, int end) {
	 ...
	 */
	public static Answers updateAnswers(Answers answers) {
	...
	public static void setService(AnswersLocalService service) {
		_service = service;
	}

	private static volatile AnswersLocalService _service;
