...
/**
 * Provides the local service interface for Answers. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AnswersLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AnswersLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>avanis.comunidad.service.impl.AnswersLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the answers local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AnswersLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public List<Answers> createUpdate(
