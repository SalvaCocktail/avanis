...
/**
 * Provides the local service interface for AnswersUser. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AnswersUserLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AnswersUserLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>avanis.comunidad.service.impl.AnswersUserLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the answers user local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AnswersUserLocalServiceUtil} if injection and service tracking are not available.
	 */
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AnswersUser getAnswersUser(long answerUserId) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AnswersUser> getAnswersUserByAnswerIdSUserId(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AnswersUser> getAnswersUserBySurveyIdUserId(
