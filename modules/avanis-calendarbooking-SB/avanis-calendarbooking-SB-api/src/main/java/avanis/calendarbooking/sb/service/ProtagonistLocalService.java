...
/**
 * Provides the local service interface for Protagonist. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ProtagonistLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ProtagonistLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>avanis.calendarbooking.sb.service.impl.ProtagonistLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the protagonist local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ProtagonistLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Protagonist> getProtagonistsByCalendarBookingId(
	...
	public Protagonist updateProtagonist(
			...
			String bio, long portraitId, ServiceContext serviceContext)
		throws PortalException;
