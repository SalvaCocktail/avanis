...
public class AvanisMeteoAlertaMVCResourceCommand extends BaseMVCResourceCommand {

        private static final Log _log = LogFactoryUtil.getLog(AvanisMeteoAlertaMVCResourceCommand.class);
        ...
        protected void doServeResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
                ...
                // Actualizar alerta en tu tabla personalizada
                AlertasLocalServiceUtil.createAlerta(null, description, true,
                        explotacionId, phenomenon, userId, end, start, risk, scope, probability);
