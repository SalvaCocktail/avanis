...
public class CalendarUtil {
    ...
    public static JSONArray toCalendarBookingsJSONArray(
        ...
        List<String> allowedRoles = ListUtil.fromArray("Administrator", "ROLE_ADMIN", "ROLE_MANAGER", "ROLE_SUPER_MANAGER");
        ...
        for (CalendarBooking calendarBooking : calendarBookings) {
            // Lógica para omitir el evento si no tiene acceso y no es el creador
            if (!hasAccess && calendarBooking.getUserId() != themeDisplay.getUserId()) {
                continue; // Omitir el evento
            }
