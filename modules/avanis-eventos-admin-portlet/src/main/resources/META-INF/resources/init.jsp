...
page import="avanis.eventos.admin.portlet.constants.AvanisEventosAdminPortletKeys" %><%@
page import="avanis.eventos.admin.portlet.display.context.CalendarDisplayContext" %><%@
page import="avanis.eventos.admin.portlet.search.CalendarResourceDisplayTerms" %><%@
page import="avanis.eventos.admin.portlet.security.permission.resource.CalendarBookingPermission" %><%@
page import="avanis.eventos.admin.portlet.security.permission.resource.CalendarPermission" %><%@
page import="avanis.eventos.admin.portlet.security.permission.resource.CalendarPortletPermission" %><%@
page import="avanis.eventos.admin.portlet.security.permission.resource.CalendarResourcePermission" %><%@
page import="avanis.eventos.admin.portlet.util.CalendarResourceUtil" %><%@
page import="avanis.eventos.admin.portlet.util.CalendarUtil" %><%@
page import="avanis.eventos.admin.portlet.util.ColorUtil" %><%@
...
String defaultView = portletPreferences.getValue("defaultView", "month");
...
CalendarBooking calendarBooking = (CalendarBooking)request.getAttribute(AvanisEventosAdminPortletKeys.CALENDAR_BOOKING);
...
CalendarDisplayContext calendarDisplayContext = (CalendarDisplayContext)renderRequest.getAttribute(AvanisEventosAdminPortletKeys.CALENDAR_DISPLAY_CONTEXT);
