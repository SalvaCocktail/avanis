<%-- Created by IntelliJ IDEA. User: noemizarco & Satory Date: 24/7/24 Time:
08:52 To change this template use File | Settings | File Templates. --%> 
...
<div class="av-te-plotDetail av-te-column-show av-te-pd">
  <a
    href="#"
    class="av-te-pd__link-to-plots link-l"
  ...
  <div class="av-te-pd__container">
    <div class="av-te-pd__top">
      <div class="av-te-pd__top-row-001">
        ...
        <div class="av-te-pd__icons-action">
          ...
          <div
            class="av-te-pd__icon av-te-pd__icon--open-dltplotmodal"
            style="pointer-events: none"
          >
            <svg
              width="18"
      ...
      <div class="av-te-pd__top-row-002">
        <div class="av-te-pd__plot-location">Tu ubicación</div>
      </div>
      <div class="av-te-pd__top-row-003">
        <ul class="av-te-pd__plot-uses">
          <li class="av-te-pd__plot-uses-category body-m-inverse">
            <span>Usos: Olivares , Cereales</span>
          </li>
        </ul>
      </div>
      <div class="av-te-pd__top-row-005">
        <h5 class="h5-inverse">Cielo despejado</h5>
      </div>
      <div class="av-te-pd__top-row-006">
        <div class="av-te-pd__focused-temperatute">
          <div
            class="av-te-pd__symbol av-te-pd__symbol--big symbol-icon symbol-icon--1"
          ></div>
          <span class="weather-temperature-big-inverse"> 21º </span>
        </div>
      ...
      <div class="av-te-pd__top-row-008">
        <div class="av-te-pd__weather-by-hours">
          <!-- <div class="av-te-pd__weather-by-hours-item">
              <span class="text-label">
                1:00
              </span>
              <div class="av-te-pd__symbol av-te-pd__symbol--small symbol-icon symbol-icon--1"></div>
              <span class="body-s">
                10º
              </span>
            </div> -->
        ...
        <div class="av-te-pd__weather-by-hours-arrows">
          <svg
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            class="av-te-pd__weather-by-hours-arrows--left"
          >
            <circle
              cx="16"
              cy="16"
          ...
          >
            ...
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M16.1946 11.5286C16.455 11.2682 16.8771 11.2682 17.1374 11.5286L21.1374 15.5286C21.2624 15.6536 21.3327 15.8232 21.3327 16C21.3327 16.1768 21.2624 16.3464 21.1374 16.4714L17.1374 20.4714C16.8771 20.7317 16.455 20.7317 16.1946 20.4714C15.9343 20.211 15.9343 19.7889 16.1946 19.5286L19.0565 16.6666H11.3327C10.9645 16.6666 10.666 16.3682 10.666 16C10.666 15.6318 10.9645 15.3333 11.3327 15.3333H19.0565L16.1946 12.4714C15.9343 12.211 15.9343 11.7889 16.1946 11.5286Z"
              fill="white"
            />
          </svg>
        </div>
    ...
    <div class="av-te-pd__bottom">
      <h5 class="h5-inverse">Los próximos 10 días</h5>

      <div class="av-te-pd__bottom-content">
        <div
          class="av-te-pd__bottom-content-items"
          style="pointer-events: none"
        ></div>
        <div
          class="av-te-pd__bci-bottom-alert-tags av-te-pd__visible"
          style="pointer-events: none"
        >
          <div
            class="av-te-pd__bci-bottom-alert-tag av-te-pd__bci-bottom-alert-tag--yellow"
            style="width: 92px; transform: translate(92px)"
            style="pointer-events: none"
          >
            <div
              class="av-te-pd__bci-bottom-alert-tag-text"
              style="pointer-events: none"
            >
              <span
                class="alert-tag"
          ...
          <div
            class="av-te-pd__bci-bottom-alert-tag av-te-pd__bci-bottom-alert-tag--orange"
            style="width: 184px; transform: translate(184px)"
            style="pointer-events: none"
          >
            <div
              class="av-te-pd__bci-bottom-alert-tag-text"
            ...
            >
              <span
                ...
                style="pointer-events: none"
              >
                Aviso por fuertes vientos de nivel naranja
              </span>
            </div>
            <div class="av-te-pd__bci-bottom-alert-tag-chebron">
              <svg
      ...
      <div class="av-te-pd__bottom-content-legend av-te-pd__visible">
        <span class="alert-title bcl-text-risk">Riesgo:</span>
        <div
          class="av-te-pd__legend-circle av-te-pd__legend-circle--warnig"
        ></div>
        <span class="alert-title">Bajo</span>

        <div
          class="av-te-pd__legend-circle av-te-pd__legend-circle--severe"
        ></div>
        <span class="alert-title">Importante</span>

        <div
          class="av-te-pd__legend-circle av-te-pd__legend-circle--error"
        ></div>
...
<script type="text/javascript">
  ...
  function handleListeners() {
    ...
    var mes = fechaActual.getMonth(); // Enero es 0
    ...
    var diaFormateado = (dia < 10 ? '0' : '') + dia;
    var fechaFormateada = diaFormateado + ' de ' + meses[mes] + ' de ' + anio;

    spanFecha.textContent = fechaFormateada;

    // Poner la fecha de los próximos 10 días.
    var container = document.querySelector('.av-te-pd__bottom-content-items');
    var currentDate = new Date();

    var daysOfWeek = ['dom.', 'lun.', 'mar.', 'mié.', 'jue.', 'vie.', 'sáb.'];

    // Función para generar una temperatura aleatoria dentro de un rango específico
    function generateRandomTemperature(min, max) {
      return Math.floor(Math.random() * (max - min + 1)) + min;
    }

    // Función para seleccionar un número aleatorio con mayoría de 1
    function selectRandomSymbol() {
      var symbols = [1, 1, 1, 3, 4];
      return symbols[Math.floor(Math.random() * symbols.length)];
    }

    // Temperaturas mínimas y máximas iniciales dentro del rango permitido
    var baseMinTemp = 21; // Temperatura mínima inicial para el primer día
    var baseMaxTemp = 26; // Temperatura máxima inicial para el primer día

    for (var i = 0; i < 10; i++) {
      var dayIndex = (currentDate.getDay() + i) % 7;
      var abbreviatedDay = daysOfWeek[dayIndex];

      // Ajustar las temperaturas para el primer día
      if (i === 0) {
        var minTemp = baseMinTemp;
        var maxTemp = baseMaxTemp;
        var symbolNumber = 1; // Icono fijo para el primer día
      } else {
        // Generar temperaturas mínimas y máximas para los días siguientes
        var minTemp = generateRandomTemperature(baseMinTemp, baseMinTemp + 4);
        var maxTemp = generateRandomTemperature(baseMaxTemp, baseMaxTemp + 4);

        // Asegurarse de que la temperatura mínima no sea mayor que la máxima
        if (maxTemp < minTemp) {
          var temp = maxTemp;
          maxTemp = minTemp;
          minTemp = temp;
        ...
        // Asegurarse de que las temperaturas estén dentro del rango permitido
        minTemp = Math.max(20, minTemp);
        maxTemp = Math.min(30, maxTemp);

        // Incrementar ligeramente el rango para el siguiente día
        baseMinTemp = Math.min(30, baseMinTemp + 1);
        baseMaxTemp = Math.min(30, baseMaxTemp + 1);

        // Seleccionar un símbolo aleatorio para los días siguientes
        var symbolNumber = selectRandomSymbol();
      }

      // Crea un elemento div con la estructura HTML deseada
      var dayElement = document.createElement('div');
      dayElement.className = 'av-te-pd__bottom-content-item';
      dayElement.innerHTML =
        '<div class="av-te-pd__bci-top ' +
        (i === 0 ? 'av-te-pd__bci-top--selected' : '') +
        '">' +
        '<span class="text-label text-capitalize av-te-pd__day-of-week-name">' +
        (i === 0 ? 'Hoy' : abbreviatedDay) +
        '</span>' +
        '<h2>' +
        (currentDate.getDate() + i).toString().padStart(2, '0') +
        '</h2>' +
        '<div class="av-te-pd__symbol av-te-pd__symbol--small symbol-icon symbol-icon--' +
        symbolNumber +
        '"></div>' +
    ...
    // Poner las horas del día.
    var containerHours = document.querySelector('.av-te-pd__weather-by-hours');

    // Función para generar una temperatura progresiva a lo largo del día
    function generateTemperature(hour) {
      var minTemp = 20;
      var maxTemp = 30;

      // Calcular temperatura en función de la hora
      if (hour <= 18) {
        // Temperatura aumenta hasta las 18:00
        return Math.round(minTemp + (maxTemp - minTemp) * (hour / 18));
      } else {
        // Temperatura disminuye después de las 18:00
        return Math.round(minTemp + (maxTemp - minTemp) * ((24 - hour) / 6));
      }
    }

    // Función para seleccionar un número de símbolo (1, 3 o 4)
    function selectRandomSymbol() {
      var symbols = [1, 3, 4];
      return symbols[Math.floor(Math.random() * symbols.length)];
    }
    ...
    for (var hour = 1; hour <= 23; hour++) {
      // Generar una temperatura para la hora
      var temperature = generateTemperature(hour);
      ...
      hourElement.className = 'av-te-pd__weather-by-hours-item';
      ...
      // Añade el elemento al contenedor
      containerHours.appendChild(hourElement);
    }
  }

  // Control para que la función no se lance más de una vez.
  var controlHandleFunctionModals = false;
  function handleFunctionOnceModals() {
    if (!controlHandleFunctionModals) {
      controlHandleFunctionModals = true;
      handleListeners();
    }
  }
