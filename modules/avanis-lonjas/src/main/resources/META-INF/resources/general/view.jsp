...
<div class="av-lm">
	<div class="av-lm__container">
		<div class="av-lm__columns">
			<div class="av-lm__column av-lm_column--left av-lm-cl js-av-lm-cl av-theme__hidden-mobile">
				<div class="av-lm-cl__row av-lm-cl__row--001">
					<div class="av-theme__icon-box-32 av-theme__hidden-desktop js-av-lm-cl-back-icon">
				...
				<div class="av-lm-cl__row av-lm-cl__row--003 js-av-lm-cl__favorites-tabs">
					<div class="av-lm-cl__tab js-av-lm-cl__tab av-lm-cl__tab--selected av-lm-cl__tab--all" variacion-porcentaje-type="all">
						<span>Todos</span>
					</div>
					<div class="av-lm-cl__tab js-av-lm-cl__tab av-lm-cl__tab--up" variacion-porcentaje-type="up">
					...
					<div class="av-lm-cl__tab js-av-lm-cl__tab av-lm-cl__tab--down" variacion-porcentaje-type="down">
						<div class="av-thme__icon-box-24">
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" >
								<path
									fill-rule="evenodd"
					...
					<div class="av-lm-cl__tab js-av-lm-cl__tab av-lm-cl__tab--stable" variacion-porcentaje-type="stable">
						<div class="av-thme__icon-box-24">
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" >
								<path
									fill-rule="evenodd"
				...
				<div class="av-lm-cl__row av-lm-cl__row--004">
					<div class="js-av-lm-cl__favorites-empty-state av-lm-cl__favorites-empty-state av-lm-cl__favorites-empty-state--all <c:if test="${fn:length(favoritosUser) > 0}"> d-none </c:if> ">
			...
			<div class="av-lm__column av-lm_column--right av-lm-cr js-av-lm-cr">
				<div class="av-lm-cr__row av-lm-cr__row--001">
					<a href="/" class="av-lm-cr__logo av-theme__hidden-desktop">
						<img src="/documents/d/guest/logo139" alt="Logo" />
					</a>
					<div class="av-lm-cr__icon-close js-av-theme-modal-page__close-modal av-theme__icon-box-24">
				...
				<div class="av-lm-cr__row-3-to-8-container">
					<div class="av-lm-cr__row av-lm-cr__row--003">
						<p>
							Descubre más de ${totalPrecioLonja} precios de diferentes lonjas y mercados sobre ${totalAreas} productos agroalimentarios distintos.
					...
					<div class="av-lm-cr__row av-lm-cr__row--004">
						<div class="av-lm-cr__dropdown js-av-lm-cr__dropdown">
							<div class="av-lm-cr__dropdown-backdrop js-av-lm-cr__dropdown-backdrop av-theme__hidden"></div>
							<div class="av-lm-cr__dropdown-btn js-av-lm-cr__dropdown-btn">
								<span id="texto-seleccion-lonjas">Seleccionar Lonjas</span>
								<span id="contador-lonjas" class="circulo-contador-verde"></span>
								<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="js-av-lm-cr__dropdown-svg" >
									<path
										fill-rule="evenodd"
										clip-rule="evenodd"
							...
							<div class="av-lm-cr__dropdown-menu js-av-lm-cr__dropdown-menu av-theme__hidden">
								<label class="js-av-lm-cr__dropdown-item" href="#">
									<input type="checkbox" value="all" checked />
									<span class="av-theme__capitalize-first">Todas las lonjas</span>
								</label>
								<c:forEach var="lonja" items="${lonjasTodas}">
									<label class="js-av-lm-cr__dropdown-item" href="#">
										<input type="checkbox" value="${lonja.lonjaId}" />
										<span class="av-theme__capitalize-first">${lonja.nombre}</span>
									</label>
								</c:forEach>
							</div>
						</div>
					...
					<div class="av-lm-cr__row av-lm-cr__row--005">
						<div class="av-lm-cr__tabs-gradient av-lm-cr__tabs-gradient--left av-theme__hidden"></div>
						<div class="av-lm-cr__tabs-gradient av-lm-cr__tabs-gradient--right"></div>
						<div class="av-lm-cr__tabs js-av-lm-cr__tabs av-theme__slider-draggable">
							<div class="av-lm-cr__tab js-av-lm-cr__tab av-lm-cr__tab-selected" data-group-id="all" data-total="${totalPrecioLonja}">
								<span>Todos</span>
							</div>
							<c:forEach var="entry" items="${listasPorGrupo}">
								<c:set var="productos" value="${entry.value}" />
								<c:set var="grupoNombre" value="${productos[0].nombreGrupo}" />
								<c:if test="${fn:length(productos) > 0}">
									<div class="av-lm-cr__tab js-av-lm-cr__tab" data-group-id="${entry.key}" data-total="${fn:length(productos)}">
										<span class="av-theme__capitalize-first">${grupoNombre}</span>
									</div>
								</c:if>
							</c:forEach>
						</div>
					...
					<div class="av-lm-cr__row av-lm-cr__row--006">
						<div class="av-lm-cr__results">
							<span>Mostrando</span>
							<span class="av-lm-cr__results-wrong" id="total-resultados">&nbsp; ${totalPrecioLonja} &nbsp;</span>
							<span>resultados</span>
						</div>
						<form action="av-lm-cr__dropdown-order-form">
							<div class="av-lm-cr__dropdown-order js-av-lm-cr__dropdown-order">
								<div class="av-lm-cr__dropdown-order-backdrop js-av-lm-cr__dropdown-order-backdrop av-theme__hidden"></div>
								<div class="av-lm-cr__dropdown-order-btn js-av-lm-cr__dropdown-order-btn">
									<span>Ordenado alfabéticamente</span>
									<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="js-av-lm-cr__dropdown-order-svg">
										<path
											fill-rule="evenodd"
											clip-rule="evenodd"
											d="M12 16C12.2652 16 12.5196 15.8946 12.7071 15.7071L18.7071 9.70711C19.0976 9.31658 19.0976 8.68342 18.7071 8.29289C18.3166 7.90237 17.6834 7.90237 17.2929 8.29289L12 13.5858L6.70711 8.29289C6.31658 7.90237 5.68342 7.90237 5.29289 8.29289C4.90237 8.68342 4.90237 9.31658 5.29289 9.70711L11.2929 15.7071C11.4804 15.8946 11.7348 16 12 16Z"
								...
								<div class="av-lm-cr__dropdown-order-menu js-av-lm-cr__dropdown-order-menu av-theme__hidden">
									<label class="js-av-lm-cr__dropdown-order-item" href="#">
										<input type="radio" name="opcionOrder" value="label-alphabetical" checked />
										Ordenado alfabéticamente
									</label>
									<label class="js-av-lm-cr__dropdown-order-item" href="#">
										<input type="radio" name="opcionOrder" value="label-date" />
										Ordenado por fecha
									</label>
									<label class="js-av-lm-cr__dropdown-order-item" href="#">
										<input type="radio" name="opcionOrder" value="label-variation" />
					...
					<div class="av-lm-cr__row av-lm-cr__row--007" id="div_listaProductos">
						...
						<c:set var="productosMostradosSeguro" value="${empty productosMostrados ? '0' : productosMostrados}" />
						<fmt:parseNumber var="productosMostradosNumero" value="${productosMostradosSeguro}" integerOnly="true" parseLocale="es_ES" />
					...
					<div class="av-lm-cr__row av-lm-cr__row--008">
						<div id="cargar-mas" class="av-theme__btn av-theme__btn--primary patata">
...
<script type="text/javascript">
  ...
  let activeFavoritos = 'all';
  let favoritos;
  let favoritosFiltrados;

  const isDefaultUser = '${isDefaultUser}' === 'true';
  ...
  document.addEventListener('click', function(event) {
	  if (event.target.classList.contains('av-lm-cr__view-evolution')) {
		  if(isDefaultUser){
			  mostrarModal();
		  }
	  }
  ...
  let manageDraggable = function() {
          ...
          tab.addEventListener('click', function () {
              ...
              $.ajax({
                  ...
                  success: function (data, textStatus, jqXHR) {
                      ...
                      // Inicializar comportamiento nuevamente después de obtener los productos
                      //inicializarComportamiento();
    ...
    $('.js-av-lm-cr__dropdown-btn').on('click',function(){
         $(this).siblings('.js-av-lm-cr__dropdown-menu').toggleClass('av-theme__hidden');
      });

      $('.js-av-lm-cr__dropdown-order-btn').on('click',function(){
         $(this).siblings('.js-av-lm-cr__dropdown-order-menu').toggleClass('av-theme__hidden');
      });

  $(document).on('click', '.av-icon-close, .modal-seguidores', function() {
